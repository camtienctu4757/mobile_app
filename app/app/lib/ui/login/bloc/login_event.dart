...
@freezed
class InitialLogin extends LoginEvent with _$InitialLogin {
  const factory InitialLogin() = _InitialLogin;
}
@freezed
...
@freezed
class LoginGooglePressed extends LoginEvent with _$LoginGooglePressed {
  const factory LoginGooglePressed() = _LoginGooglePressed;
}
