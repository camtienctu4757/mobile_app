...
from thirdparty.connections import PostgresConnection, MinioConnection, RedisConnection,KeycloakConnection
...
from routers.v1.endpoints import healthcheck, file
...
def get_application() -> FastAPI:
    ...
    application.include_router(file.router, prefix=ApiVersion.v1.value)
